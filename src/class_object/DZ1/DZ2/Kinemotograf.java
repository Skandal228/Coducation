...
public class Kinemotograf {
   /* Задача 2 Создать класс Film с атрибутами:
...
В мейне созать массив Film[] на 10 элементов, заполнить его любым способом объектами класса Film.
Выполнить действия с массивом:
1. Вывести все фильмы
2. Вывести все фильмы режиссера x (x юзер вводит с консоли)
3. Вывести все фильмы, чья длительность меньше x и рейтинг выше y (x, y юзер вводит с консоли)*/
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length ; i++) { // Вывел все фильмы на экран
...
//            System.out.println();
        ...
        String cursorDirector = src.nextLine();
        boolean isExist=false;


        for (int i = 0; i < arr.length; i++) {
            if (cursorDirector.equals(arr[i].nameDirector)){
                System.out.println("Название фильма: " + arr[i].nameFilm);
                System.out.println("Режисер: " + arr[i].nameDirector);
                System.out.println("Рейтинг: " + arr[i].rating);
                System.out.println("Длительнойсть: " + arr[i].duration);
...
class Film{
    String nameFilm;     //название
    String nameDirector; //режиссер
